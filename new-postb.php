      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-lg-8 mb-5">
			     <form method="POST" action="jobs_upload.php" class="p-5 bg-white">
<!----------------Post Job Form---------->
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" >Employer Contact</label>
                  <input required type="number" name="employer_contact" class="form-control" placeholder="eg. +255645323241" required>
                </div>
              </div>
              <div class="row form-group mb-5">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" >Email Contact</label>
                  <input required type="email" name="employer_email" class="form-control" placeholder="eg. user@gmail.com" required>
                </div>
              </div>
              <div class="row form-group mb-5">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" >Job Title</label>
                  <input required type="text" name="job_title" class="form-control" placeholder="eg. Special Event Cook" required>
                </div>
              </div>
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label >
                    <input required type="radio"  name="job_type" value="Full time" required> Full Time
                  </label>
                </div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label >
                    <input required type="radio"  name="job_type" value="Part Time"> Part Time
                  </label>
                </div>

                <div class="col-md-12 mb-3 mb-md-0">
                  <label >
                    <input required type="radio"  name="job_type" value="Temporary"> Temporary
                  </label>
                </div>
              </div>

               <div class="row form-group">
                <div class="col-md-12"><h3>Minimum Experience Required</h3></div>
                <div class="col-md-12 mb-3 mb-md-0">
                  <label >
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <textarea name="job_description" class="form-control"  cols="30" rows="5" required></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input required type="submit" value="Post" class="btn btn-primary  py-2 px-5">
                </div>
              </div>
            </form>
          </div>
<!----------------------------Contact Info--------------------->
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-0"><a href="#"><span class="__cf_email__" data-cfemail="671e081215020a060e0b2703080a060e094904080a">diliTz123@gmail.com</span></a></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="register.html" class="py-2 d-block">Register</a></li>
