...
<!-----------------------Picture Content------------------------->
    <div class="hero-wrap js-fullheight" style="background-image: url('images/Tools1.jpg');" data-stellar-background-ratio="0.5">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>You can also get expert candidates in the kind of job you want to be completed.</p>
              </div>
            </div>      
          </div>
        </div>
...
?>
 <!------------------End of the Php------------------->
          ...
          <div class="col text-center">
            <div class="block-27">
              <ul>
                <li><a href="indexb.php">&lt;</a></li>
                <li class="active"><span>1</span></li>
                <li><a href="indexb.php"><span>2</span></a></li>
                <li><a href="indexb.php">&gt;</a></li>
              </ul>
            </div>
          </div>
