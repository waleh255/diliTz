	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="contactb.php" class="nav-link">Contact</a></li>
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="contacta.php"><span class="icon icon-envelope"></span><span class="text">diliTz123@gmai.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
