...
<!--------------------Collapsible------------------->
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item cta cta-colored"><a href="log_reg.php" class="nav-link">Log In / Register</a></li><pre> </pre>
          </ul>
        </div>
      </div>
    </nav>
                ...
                <div class="col-md-12 tab-wrap">
                  ...
                  <div class="tab-content p-4" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                              <form method="post" action="job-posta.php" class="search-job">
                        <div class="row">
                          <div class="col-md">
                            ...
                            <div class="form-group">
                              <div class="form-field">
                                <div class="select-wrap">
                                  ...
                                  <select required name="job_type_search" id="" class="form-control">
                         ...
                         <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                  <div class="select-wrap">
                                      <div class="icon"><span class="ion-ios-arrow-down" ></span></div>
                                          <select required name="level_req_search" id="" class="form-control">
...
$sql = "SELECT num, job_title, job_type, location, job_description, level_req FROM jobs WHERE job_title LIKE '%" . $job_title_search . "%' AND job_type LIKE '%" .$job_type_search."%' AND level_req LIKE '%" .$level_req_search."%' ORDER BY num DESC";
          ...
          <div class=\"col-md-12 ftco-animate\">
            <div class=\"job-post-item bg-white p-4 d-block d-md-flex align-items-center\">
              ...
              echo "<center><h3>Oops! Sorry, No Jop Posts Yet!!</h3></center>";          }
          $conn->close();
        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="loq_reg.php" class="py-2 d-block">Register</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a href="log-reg.php" class="py-2 d-block">Register</a></li>
