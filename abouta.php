...
<!--------------------------COLLAPSE NAVBAR------------------->
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="abouta.php" class="nav-link">About</a></li>
            ...
            <li class="nav-item cta cta-colored"><a href="log_reg.php" class="nav-link">Want a Job</a></li><pre> </pre>
	          ...
	          <li class="nav-item cta cta-colored"><a href="log_reg.php" class="nav-link">Log In / Register</a></li>
            <pre> </pre>
	        </ul>
	      </div>
	    </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">Being a mother of three it is hard to make sure that when i am away my kids get the best care that i can offer them, but ever since i started using diliTz,
                      their skilled baby sitters have made sure that i can concentrate on my work and worry a bit less about my kids well being when i am away.</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">diliTz made it possible for me to go to work work and not to worry much about how i am going to clean my house over the weekend because i am not married.
                      But thanks to diliTz allk of this is no longer a woryy.</p>
