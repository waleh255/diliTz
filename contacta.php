...
<html lang="en">
  ...
  <!---------------------------NAVIGATION BAR------------------------------>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="contacta.php" class="nav-link">Contact</a></li>
            <li class="nav-item cta cta-colored"><a href="job-posta.php" class="nav-link">Want a Job</a></li><pre> </pre>
	          <li class="nav-item cta mr-md-2"><a href="new-postb.php" class="nav-link">Post a Job</a></li>
           <li class="nav-item cta cta-colored"><a href="job-post.php" class="nav-link">Log In / Register</a></li><pre> </pre>
	        </ul>
	      </div>
	    </div>
	  </nav>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/Tools5.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span> CoICT, Sayansi Kijitonyama</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">+ 255 620 757 549</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:diliTZ@gmail.com">diliTz@gmail.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#http://udicti.coict.udsm.ac.tz">udicti.coict.udsm.ac.tz</a></p>
          </div>
        </div>
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+2550620757549</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">diliTz123@gmai.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
